...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"channel-variant\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c channel-variant -s couchdb"
...
#default for delay
CLI_DELAY=3
# channel name defaults to "channel-variant"
