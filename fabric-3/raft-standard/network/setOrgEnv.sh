...
ORDERER_CA=${DIR}/network/organizations/ordererOrganizations/fabric3.standard/tlsca/tlsca.fabric3.standard-cert.pem
PEER0_ORG1_CA=${DIR}/network/organizations/peerOrganizations/org1.fabric3.standard/tlsca/tlsca.org1.fabric3.standard-cert.pem
PEER0_ORG2_CA=${DIR}/network/organizations/peerOrganizations/org2.fabric3.standard/tlsca/tlsca.org2.fabric3.standard-cert.pem
PEER0_ORG3_CA=${DIR}/network/organizations/peerOrganizations/org3.fabric3.standard/tlsca/tlsca.org3.fabric3.standard-cert.pem
