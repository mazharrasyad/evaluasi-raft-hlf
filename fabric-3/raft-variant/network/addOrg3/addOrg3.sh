...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"fabric3-channel-standard\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c fabric3-channel-standard -s couchdb"
...
#default for delay
CLI_DELAY=3
# channel name defaults to "fabric3-channel-standard"
