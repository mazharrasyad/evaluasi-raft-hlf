...
const NETWORK_START_TARGETS = [
    {
        ...
        commands: [
            ...
            },
            {
                ...
                displayCommand:
                    './network.sh deployCCAAS -ccn pelaporan -ccp ../chaincode/pelaporan -ccs auto -c raft',
            },
        ],
    },
    {
        ...
        commands: [
            ...
            },
            {
                ...
                displayCommand:
                    './network.sh deployCCAAS -ccn pelaporan -ccp ../chaincode/pelaporan -ccs auto -c smartbft',
            },
        ],
    },
];
